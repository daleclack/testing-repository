...
#Get the necessary components
apt-get install openbox-session open box lxpanel gnome-terminal lxappearance -y
...
apt-get install build-essential codeblocks kdevelop cmake htop konsole vim  leafpad aqemu qemu -y
apt-get install chromium-browser okular qemu-system-* -y
